    ...
    return (
      <>
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="h-[40rem] sm:h-[30rem] md:h-[50rem] flex-grow-0 flex justify-center items-center px-0 md:px-2">
        ...
        <div className="flex justify-center items-center">
          <div className="relative w-6 h-10 border-2 border-slate-50 opacity-75	rounded-3xl justify-center items-center translate-y-[-45px] hidden lg:flex">
