    ...
    return (
        <div>
            <div className='flex flex-col p-6 bg-black h-full justify-between rounded-lg border border-white shadow-[10px_10px_0px_0px_rgba(255,255,255,1)]'>
                <a href={link} target='_blank' className="overflow-hidden rounded-lg">
                    <Image
                        src={imageSrc}
                ...
                <div className='flex flex-col gap-2 my-3 justify-start w-full'>
                    ...
                    <a href={link} target='_blank' className='text-3xl text-[#F5F5F5] leading-9 cursor-pointer font-semibold underline-offset-2 hover:underline'>{projectName}</a>
                    <a href={link} target='_blank' className='text-lg cursor-pointer font-semibold underline-offset-2 underline'>Visit</a>
                </div>
            </div>
        </div>
    );
